  ...
  return (
    <nav className="bg-blue-500 sm:flex w-full sm:justify-between sm:items-center sm:px-4 sm:py-2 fixed z-10">
      ...
      >
        ...
        <button
          className="inline-flex  items-center mt-1 md:pl-3 md:pr-1 px-2 py-1 font-semibold rounded focus:bg-yellow-300 focus:text-blue-500 hover:bg-yellow-300 hover:text-blue-500 text-gray-50 md:mt-0  outline-none focus:outline-none 
        ...
        >
          ...
          <Link to="/servicios/vehiculos">Préstamo de Vehiculo</Link>
